...
ActiveRecord::Schema.define(:version => 20111126140215) do

  create_table "devonshires", :force => true do |t|
    t.string   "title"
    t.text     "description"
  ...
  create_table "guitar_pics", :force => true do |t|
    t.string   "title"
    t.text     "description"
    t.string   "photo_file_name"
    t.string   "photo_content_type"
  ...
  create_table "project_pics", :force => true do |t|
    t.string   "name"
    t.text     "description"
    t.string   "photo_file_name"
    t.string   "photo_content_type"
